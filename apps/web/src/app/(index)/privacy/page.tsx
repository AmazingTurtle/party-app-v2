        ...
        <article className="legal-container">
          ...
          <section>
            ...
            <p>
              ...
              page. The postal address and other provider details are available
              in the <Link href="/imprint">imprint</Link>. For privacy
              questions, email{' '}
          ...
          <section>
            ...
            <p>
              ...
              process technical request data such as your IP address, browser
              and device information, requested URL, referrer, timestamps,
              response status, and diagnostic data. This processing is necessary
              to deliver and protect the site. The legal basis is Article
              6(1)(f) GDPR and the legitimate interest in operating a secure,
              reliable website.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              your browser so the app can remain usable offline. This cached
              data stays on your device and can be removed through your
          ...
          <section>
            ...
            <p>
              The current version does not use application analytics,
              advertising trackers, marketing cookies, contact forms, or
              profiling. If this changes, this policy must be updated before the
