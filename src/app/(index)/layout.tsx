...
export default function IndexLayout({ children }: { children: ReactNode }) {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-4 lg:p-24 overflow-hidden">
      <div className="z-10 max-w-5xl w-full text-sm flex-col">
        <div className="fixed bottom-0 left-0 flex flex-col items-center justify-end h-48 w-full bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none pb-4">
          <Link
